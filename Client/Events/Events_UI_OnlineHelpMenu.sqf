...
Commander can also set orders to Team Leaders, ie. to capture selected town, or go to some spot on map. Thie is true for both AI units and Player owned.
