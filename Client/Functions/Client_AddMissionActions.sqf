...
if (missionNamespace getVariable "CTI_SM_RADAR" == 1) then {
	player addEventHandler ["WeaponAssembled",{["SERVER", "Server_ARTR_handle",(_this select 1)] call CTI_CO_FNC_NetSend;["SERVER", "Server_AIRR_handle",_vehicle] call CTI_CO_FNC_NetSend;}];
};
