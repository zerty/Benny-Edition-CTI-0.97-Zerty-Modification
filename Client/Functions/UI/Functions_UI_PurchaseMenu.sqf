...
CTI_UI_Purchase_UpdateVehicleIcons = {
	...
	if (_classname isKindOf "Man"||_classname isKindOf "UAV_01_base_F" ||_classname isKindOf "B_T_UAV_03_F" ||_classname isKindOf "UGV_01_base_F"||_classname isKindOf "UAV"||_classname isKindOf "StaticWeapon" ||_classname isKindOf "Thing" || (leader group player)!= player ) then {
		// {
