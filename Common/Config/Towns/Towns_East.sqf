with missionNamespace do {
	...
	//--- Vehicles
	EAST_VEHICLES_LIGHT = [EAST_MOTORIZED_MG, EAST_MOTORIZED_GL, EAST_MOTORIZED_MG];
	EAST_VEHICLES_MEDIUM = [["O_APC_Wheeled_02_rcws_F", 2], ["O_APC_Tracked_02_cannon_F", 2]];
	EAST_VEHICLES_HEAVY = [["O_MBT_02_cannon_F", 2]];
	EAST_VEHICLES_AA_LIGHT = [["O_APC_Tracked_02_AA_F", 1]];
};