with missionNamespace do {
	...
	//--- Vehicles
	GUER_VEHICLES_LIGHT = ["I_MRAP_03_hmg_F","I_MRAP_03_gmg_F","I_G_Offroad_01_armed_F"];
	GUER_VEHICLES_MEDIUM = ["I_APC_Wheeled_03_cannon_F","I_APC_tracked_03_cannon_F"];
	GUER_VEHICLES_HEAVY = ["I_MBT_03_cannon_F"];
