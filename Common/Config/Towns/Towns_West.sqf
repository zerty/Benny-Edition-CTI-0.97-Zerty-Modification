with missionNamespace do {
	...
	//--- Vehicles
	WEST_VEHICLES_LIGHT = [WEST_MOTORIZED_MG, WEST_MOTORIZED_GL, WEST_MOTORIZED_MG];
	WEST_VEHICLES_MEDIUM = [["B_APC_Wheeled_01_cannon_F", 2], ["B_APC_Tracked_01_rcws_F", 2]];
	WEST_VEHICLES_HEAVY = [["B_MBT_01_cannon_F", 2], ["B_MBT_01_TUSK_F", 2]];
	WEST_VEHICLES_AA_LIGHT = [["B_APC_Tracked_01_AA_F", 1]];
};