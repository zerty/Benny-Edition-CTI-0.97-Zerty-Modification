...
if (_unit isKindOf "Man") then {
	...
	if  ( (toLower (((_gear select 3) select 0) select 1)) in ["laserdesignator","laserdesignator_02"] && ! isnull (uniformContainer _unit)) then { (uniformContainer _unit) addItemCargoGlobal ["Laserbatteries",1]} ;
