...
private ["_groups", "_pool", "_pool_group_size", "_pool_units", "_positions", "_resistanceSize", "_teams", "_totalGroups", "_totalvehicles", "_town", "_value"];
_town = _this;
...
switch (true) do {
	...
	case (_value > 100 && _value <= 150) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 30], ["GUER_VEHICLES_MEDIUM", 1, 25]]];
	};
	case (_value > 150 && _value <= 200) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 40], ["GUER_VEHICLES_MEDIUM", 1, 30]]];
	};
	case (_value > 200 && _value <= 250) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 50], ["GUER_VEHICLES_MEDIUM", 1, 35]]];
	};
	...
	case (_value > 400 && _value <= 450) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 20], ["GUER_VEHICLES_MEDIUM", 1, 35], ["GUER_VEHICLES_HEAVY", 1, 20]]];
	};
	case (_value > 450) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 15], ["GUER_VEHICLES_MEDIUM", 1, 30], ["GUER_VEHICLES_HEAVY", 1, 25]]];
	};
};
...
for '_i' from 1 to _totalGroups do {
	_leader = [GUER_SOLDIER_SQUADLEADER, GUER_SOLDIER_TEAMLEADER] call BIS_fnc_selectRandom;
	_units = [_leader];
	//_units = [];
