...
switch (true) do {
	...
	case (_value > 100 && _value <= 150) : {
		_pool_units = [[["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 1], ["GUER_SOLDIERS_AT_LIGHT", 2, 80], ["GUER_SOLDIERS_AT_HEAVY", 2, 50], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1, 70], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 1, 75]],
		[["GUER_VEHICLES_LIGHT", 1, 30], ["GUER_VEHICLES_MEDIUM", 1, 25], ["GUER_VEHICLES_HEAVY", 1, 0]]];
	};
	case (_value > 150 && _value <= 200) : {
		_pool_units = [[["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 1], ["GUER_SOLDIERS_AT_LIGHT", 2, 70], ["GUER_SOLDIERS_AT_MEDIUM", 2, 65], ["GUER_SOLDIERS_AT_HEAVY", 2, 60], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1, 75], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 1, 80]],
		[["GUER_VEHICLES_LIGHT", 1, 40], ["GUER_VEHICLES_MEDIUM", 1, 30], ["GUER_VEHICLES_HEAVY", 1, 0]]];
	};
	case (_value > 200 && _value <= 250) : {
		_pool_units = [[["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 1], ["GUER_SOLDIERS_AT_LIGHT", 2, 55], ["GUER_SOLDIERS_AT_MEDIUM", 2, 65], ["GUER_SOLDIERS_AT_HEAVY", 2, 65], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1, 75], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 1, 85]],
		[["GUER_VEHICLES_LIGHT", 1, 50], ["GUER_VEHICLES_MEDIUM", 1, 35], ["GUER_VEHICLES_HEAVY", 1, 20]]];
	};
	case (_value > 250 && _value <= 300) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 50], ["GUER_VEHICLES_MEDIUM", 1, 40], ["GUER_VEHICLES_HEAVY", 1, 25]]];
	};
	case (_value > 300 && _value <= 350) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 40], ["GUER_VEHICLES_MEDIUM", 1, 45], ["GUER_VEHICLES_HEAVY", 1, 30]]];
	};
	case (_value > 350 && _value <= 400) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 30], ["GUER_VEHICLES_MEDIUM", 1, 50], ["GUER_VEHICLES_HEAVY", 1, 35]]];
	};
	case (_value > 400 && _value <= 450) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 20], ["GUER_VEHICLES_MEDIUM", 1, 50], ["GUER_VEHICLES_HEAVY", 1, 40]]];
	};
	case (_value > 450) : {
		_pool_units = [
		...
		[["GUER_VEHICLES_LIGHT", 1, 20], ["GUER_VEHICLES_MEDIUM", 1, 50], ["GUER_VEHICLES_HEAVY", 1, 50]]];
	};
};
