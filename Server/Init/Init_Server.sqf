...

{
	...
	if (missionNamespace getvariable "CTI_VEHICLES_AIR_FFAR") then {_upgrades set [CTI_UPGRADE_AIR_FFAR,10]};
	if (missionNamespace getvariable "CTI_VEHICLES_AIR_AA") then {_upgrades set [CTI_UPGRADE_AIR_AT,10]};
	if (missionNamespace getvariable "CTI_VEHICLES_AIR_AT") then {_upgrades set [CTI_UPGRADE_AIR_AA,10]};
	if (missionNamespace getvariable "CTI_VEHICLES_AIR_CM") then {_upgrades set [CTI_UPGRADE_AIR_CM,10]};
	if (missionNamespace getvariable "CTI_TOWNS_OCCUPATION") then {_upgrades set [CTI_UPGRADE_TOWNS,10]};
