...
while {(_eastLocation distance _westLocation) <(_asked) ||(_eastLocation distance _westLocation) >( _asked)*1.5 || {(_x distance _eastLocation)<600} count CTI_Towns>0 || {(_x distance _westLocation)<600} count CTI_Towns>0 ||(_eastLocation distance CENTER_POS) > ( _asked)*0.8 ||(_westLocation distance CENTER_POS) > ( _asked)*0.8 } do {
